	...
	.toArray(),function()
{
	(function (varContext, varName)
	{
		...
		scene.prototype.execute = function(matchupData,cb)
		{
			var self = this;

			self.vis = self.createVis();
			self.data = self.createPackData(matchupData);
		...
		scene.prototype.createPackData = function(selectedMatchup)
		{
			var self = this;
			var matchup = new Matchup(selectedMatchup);
